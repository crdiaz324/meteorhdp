...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "cdiaz324-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/covario1"
  #   chef.validation_client_name = "covario1-validator"
  #   chef.validation_key_path = ".chef/covario1-validator.pem"
  # end
end
